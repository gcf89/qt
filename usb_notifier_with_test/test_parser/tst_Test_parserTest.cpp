...
void Test_parserTest::testParse_1()
{
  QString data = R"({"id":1484192689468435,
                 ...
                 "if_subclass_id":"06","if_protocol_id":"02"}]}},"text":"USB устройство присоединено",
                 "timestamp":"2017-08-06T07:22:51"},{"id":1484192689468439,
                 "value":{"raw":{"device_descriptor":{"vendor_id":"2","product_id":"2""
                 ,"dev_class_id":"03","dev_subclass_id":"00","dev_protocol_id":"01",
                 "serial_number":"flash1"},"interfaces":[{"if_class_id":"08",
                 "if_subclass_id":"06","if_protocol_id":"01"}]}},"text":"USB устройство разрешено",
                 "timestamp":"2017-08-06T07:22:51"},{"id":1484192689468439,
                 "value":{"raw":{"device_descriptor":{"vendor_id":"8564",
                 "product_id":"1000","dev_class_id":"01","dev_subclass_id":"00","dev_protocol_id":"00",
                 ...
                 ,"dev_class_id":"03","dev_subclass_id":"00","dev_protocol_id":"01",
                 "serial_number":"flash2"},"interfaces":[{"if_class_id":"08",
                 "if_subclass_id":"06","if_protocol_id":"01"}]}},"text":"USB устройство заблокировано",
                 "timestamp":"2017-08-06T07:22:51"},{"id":1484192689468439,
                 "value":{"raw":{"device_descriptor":{"vendor_id":"8564",
                 "product_id":"1000","dev_class_id":"01","dev_subclass_id":"00","dev_protocol_id":"00",
                 "serial_number":"flash1"},"interfaces":[{"if_class_id":"08",
                 "if_subclass_id":"06","if_protocol_id":"02"}]}},"text":"USB устройство извлечено",
                 "timestamp":"2017-08-06T07:22:51"},{"id":1484192689468439,
                 "value":{"raw":{"device_descriptor":{"vendor_id":"8564",
                 "product_id":"1000","dev_class_id":"01","dev_subclass_id":"00","dev_protocol_id":"00",
                 "serial_number":"flash2"},"interfaces":[{"if_class_id":"08",
  ...
  QCOMPARE(c.mHWMandatoryDisconnected.size(), 1);
  QCOMPARE(c.mHWMandatoryConnected.size(), 1);
}
